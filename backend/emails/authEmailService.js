...
export async function sendEmaiPasswordReset({ name, email, token}){
  ...
  const info = await transporter.sendMail({
      ...
      <a href="${process.env.FRONTEND_URL}/auth/olvide-password/${token}">Reestablecer</a>
      <p>Si tú no has solicitado esta acción, puedes ignorar este mensaje</p>`
